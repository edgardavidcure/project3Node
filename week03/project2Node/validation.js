...
const commentValidation = [
  ...
  check("createdAt", "date cannot be empty").not().isEmpty(),
  check("rate", "rate cannot be empty").not().isEmpty(),
  check("user", "user needs to be an object").isObject(),
];
...
module.exports = { commentValidation, userValidation, validate };
